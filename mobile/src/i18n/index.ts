    ...
    resources: {
      si: {
        translation: {
          ...
          attached: 'එකතු කර ඇත'
          ,
          saveDone: 'වාර්තාව සුරකිණි',
          saveDoneDetail: 'වාර්තාව සුරකිණි — නව වාර්තාවක් දැන් ඇතුළත් කළ හැකිය.'
          ,
          ok: 'හරි',
          saveUploaded: 'වාර්තාව සර්වර්ට යවනු ලැබීය',
          saveLocal: 'වාර්තාව දුරස්ථයෙන් සුරැකුණි — සම්බන්ධතාවය ඇති වීමෙන් පසු යාවත්කාලීන වේ'
        }
      }
    },
    lng: 'si',
