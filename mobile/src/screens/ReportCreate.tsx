...
import { View, Text, TextInput, Button, Platform, Image, Alert, Pressable } from 'react-native';
import MaterialIcons from '@expo/vector-icons/MaterialIcons';
import MaterialCommunityIcons from '@expo/vector-icons/MaterialCommunityIcons';
import { useTranslation } from 'react-i18next';
import { createReport as dbCreateReport } from '../db/reports';
...
export default function ReportCreate({ navigation }: any) {
  ...
  <Pressable onPress={onSave} style={({ pressed }: { pressed: boolean }) => ({ backgroundColor: '#22c55e', paddingVertical: 12, borderRadius: 12, opacity: pressed ? 0.85 : 1, flexDirection: 'row', justifyContent: 'center', alignItems: 'center' })}>
